...
PRAGMA set_encrypted_parquet_config('parquet.encryption.algorithm', 'AES_GCM_V1');
PRAGMA set_encrypted_parquet_config('parquet.encryption.double.wrapping', 'true');
PRAGMA set_encrypted_parquet_config('parquet.encryption.key.material.store.internally', 'true');
PRAGMA set_encrypted_parquet_config('parquet.encryption.data.key.length.bits', '128');
PRAGMA set_encrypted_parquet_config('parquet.encryption.kek.length.bits', '128');
